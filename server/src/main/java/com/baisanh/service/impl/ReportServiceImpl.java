...
import com.baisanh.dto.GoodsSalesDTO;
import com.baisanh.entity.Orders;
import com.baisanh.mapper.OrderMapper;
import com.baisanh.mapper.UserMapper;
import com.baisanh.service.ReportService;
import com.baisanh.service.WorkspaceService;
...
public class ReportServiceImpl implements ReportService {
    ...
    public OrderReportVO getOrderStatistics(LocalDate begin, LocalDate end) {
        ...
        if (begin == null || end == null) {
            log.error("getOrderStatistics方法参数错误: begin={}, end={}", begin, end);
            List<LocalDate> emptyDateList = new ArrayList<>();
            List<Integer> emptyCountList = new ArrayList<>();
    ...
    private Integer getOrderCount(LocalDateTime begin, LocalDateTime end, Integer status){
        if (begin == null || end == null) {
            log.warn("getOrderCount方法参数错误: begin={}, end={}, status={}", begin, end, status);
            return 0;
        }
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        // 入参校验
        if (begin == null || end == null) {
            log.error("getSalesTop10方法参数错误: begin={}, end={}", begin, end);
        ...
        try {
            ...
            try {
                ...
                log.error("日期转换异常，参数为null: begin={}, end={}", begin, end, e);
                return SalesTop10ReportVO.builder()
                        .nameList("")
                        .numberList("")
                        .build();
            ...
            log.error("getSalesTop10方法发生异常", e);
            return SalesTop10ReportVO.builder()
                    .nameList("")
                    .numberList("")
                    .build();
